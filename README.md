...
7. **Profile** is a month of practice days. A ring means a photo was kept. Export downloads the attempt list, not the photos.
...
| `[` `]` | Nib size |
| `Esc` | Close a page, leave Sources or Attempts, or leave the station |
